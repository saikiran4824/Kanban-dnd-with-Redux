      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-1">
          ...
          <input
            ...
            placeholder=" e.g Folder structure planning"
            value={name}
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <div>
            <button
              className=" w-full items-center hover:opacity-70 dark:text=[#C98D26] dark:bg-white  text-white bg-[#C98D26] py-2 rounded-full "
              onClick={() => {
            ...
            <button
              ...
              className=" w-full items-center hover:opacity-70 dark:text-white dark:bg-[#C98D26] mt-8 relative  text-white bg-[#C98D26] py-2 rounded-full"
            >
