    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            className=" w-full items-center dark:text=[#C98D26] dark:bg-white  text-white bg-[#C98D26] py-2 rounded-full "
            onClick={() => {
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            ...
            className=" w-full items-center text-white bg-[#C98D26] py-2 rounded-full "
          >
